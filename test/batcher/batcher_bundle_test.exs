defmodule BorsNG.Worker.BatcherBundleTest do
  ...
  describe "stack_order/1" do
    ...
    test "chains order root-first" do
      ...
      b = fake_patch(2, 2, 3)
      c = fake_patch(1, 1, 2)
      assert Batcher.stack_order([c, b, a]) == [a, b, c]
    end
    ...
    test "a stored cycle falls back to PR-number order" do
      a = fake_patch(1, 1, 2)
      b = fake_patch(2, 2, 1)
      assert Batcher.stack_order([a, b]) == [a, b]
    end
  end
